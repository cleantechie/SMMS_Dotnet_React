                ...
                centered>
                    <Modal.Header closeButton>
                        <Modal.Title id = "contained-modal-title-vcenter">
                            Edit Product Details in the Store
                        </Modal.Title>
                    </Modal.Header>
                            ...
                            <Col sm={6}>
                                <Form onSubmit={this.handleSubmit}>
                                    ...
                                    <Form.Group controlId="Category">
                                        <Form.Control type="text" name="Category" required  defaultValue={this.props.Category} placeholder="Category"/>
                                    </Form.Group>

                                    

                                    <Form.Group controlId="Price">
                                        <Form.Control type="text" name="Price" required defaultValue={this.props.Price} placeholder="Price"/>
                                    </Form.Group>
